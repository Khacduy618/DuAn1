    ...
    <div class="heading heading-flex mb-3">
        ...
        <div class="heading-right">
            <ul class="nav nav-pills nav-border-anim justify-content-center" role="tablist">
                ...
                ?>
                <li class="nav-item">
                    <a class="nav-link <?= $activeClass ?>" id="trending-<?= $items['category_id']; ?>-link"
                        data-toggle="tab" href="#trending-<?= $items['category_id']; ?>-tab" role="tab"
                        aria-controls="trending-<?= $items['category_id']; ?>-tab"
