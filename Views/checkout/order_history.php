                        ...
                        <tbody>
                            <?php foreach ($bill as $order): ?>
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="badge-b rounded-pill <?php echo getStatusBadgeClass($order['bill_status']); ?>">
                                            <?php echo $order['status_name']; ?>
                                        </span>
                                    </td>
                                    <td class="text-end pe-4">
                                        <a class="btn btn-sm btn-outline-primary" href="javascript:void(0)"
                                            onclick="showBillDetails(<?= $order['bill_id'] ?>)">
                                            Details
                                        </a>
        ...
        <?php else: ?>
            <div class="card shadow-sm">
                <div class="card-body text-center py-5">
                    <img src="assets/site/images/products/cart/carton-box.png" alt="No Orders" class="mb-4"
                        style="width: 200px;">
...
function getStatusBadgeClass($status)
{
    switch ($status) {
        ...
        case 6:
            return 'bg-primary text-white';  // Đang giao hàng
        case 7:
            return 'bg-success text-white';  // Đã giao hàng
        case 8:
