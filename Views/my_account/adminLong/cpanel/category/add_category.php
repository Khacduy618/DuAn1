...
<div class="col-md-12">
    ...
    ?>
    <form action="?act=adminLong&ctlr=AdminLongController&method=insert_category" method="POST" enctype="multipart/form-data"> <!-- enctype="multipart/form-data" vi khi phuong thuc gui file phai co cau lenh nay --> 
        <div class="row">
            <div class="col-md-6">
