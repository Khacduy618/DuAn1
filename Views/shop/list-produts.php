                ...
                <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                    <div class="product product-7 text-center">
                        <figure class="product-media">
                            ...
                            <?php } ?>
                            <a <?php if ($value['product_status'] != 0 && $value['product_count'] != 0) { ?>
                                    href="?act=product&id=<?= $value['product_id'] ?>" <?php } ?>>
                                        ...
                                        <form action="index.php?act=favorite&xuli=<?= $isFavorited ? 'delete' : 'add' ?>" method="POST">
                                            ...
                                            <?php if ($isFavorited): ?>
                                                <input type="hidden" name="favorite_id"
                                                    value="<?= $favorite->findByUserAndProduct($_SESSION['login']['user_email'], $value['product_id'])['favorite_id'] ?>">
                                            <?php endif; ?>
                                            <button type="submit"
                        ...
                        <div class="product-body">
                            ...
                            <h3 class="product-title"><a <?php if ($value['product_status'] != 0 && $value['product_count'] != 0) { ?> href="?act=product&id=<?= $value['product_id'] ?>" <?php } ?>><?= $value['product_name'] ?></a></h3>
                            <!-- End .product-title -->
