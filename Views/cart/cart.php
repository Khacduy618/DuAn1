                            ...
                            <thead>
                                <tr>
                                    <th><input type="checkbox" class="select-all-checkbox"
                                            onchange="selectAllCheckboxes()" name="select-all" id="select-all"></th>
                                    <th>Product</th>
                                    <th>Price</th>
                                    <th>Quantity</th>
                                    <th>Total</th>
                                ...
                                if (isset($cartItems)) {
                                                    ...
                                                    <div class="product">
                                                        <figure class="product-media">
                                                            <div class="product-image">
                                                                <img src="uploaded/<?= $value['product_img'] ?>"
                                                                    alt="Product image">
                                                            </div>
                                                        </figure>
                                            ...
                                            <td class="quantity-col">
                                                <div class="cart-product-quantity">
                                                    <input type="number" class="form-control quantity-input"
                                                        value="<?= $value['quantity'] ?>" min="1" max="10" step="1"
                                    ...
                                    <tr>
                                        <td colspan="5" class="text-center"><img
                                                src="assets/site/images/products/cart/carton-box.png" alt="No Orders"
                                                class="mb-4" style="width: 200px;">No products in the cart.</td>
                                    </tr>
                                    <?php
                                }
                                ?>
                        ...
                        <table class="table table-summary">
                            <tbody>
                                <tr class="summary-subtotal">
                                    <td>Subtotal:</td>
                                    <td colspan="2" class="subtotal-amount"><?= number_format($tong, 0, ",", ".") ?> đ
                                    </td>
                                ...
                                <tr class="summary-shipping-estimate">
                                    ...
                                    <td colspan="2">
                                            ...
                                            <select class="form-select" id="address_id" name="address_id">
                                                ...
                                                <?php foreach ($addresses as $addr): ?>
                                                    <option value="<?= $addr['address_id'] ?>">
                                                        <?= $addr['address_name'] ?> - <?= $addr['address_city'] ?>,
                                                        <?= $addr['address_street'] ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
                                        <?php } else { ?>
                                            ...
                                            <a href="?act=taikhoan&xuli=account" class="text-warning"><u>Vui lòng thêm
                                                    địa
                                                    chỉ</u></a>
                                        <?php } ?>
                                    </td>
                                ...
                                <tr class="summary-total">
                                    <td>Total:</td>
                                    <td colspan="2" class="total-amount"><?= number_format($total, 0, ",", ".") ?> đ
                                    </td>
