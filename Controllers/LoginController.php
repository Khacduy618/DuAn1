...
class LoginController
{
    ...
    //     } else {
    //         if ($_POST['user_passwordNew'] == $_POST['user_passwordConfirm']) {
    //             if (md5($_POST['user_password']) == $_SESSION['login']['user_password']) {
    //                 $data = array(
    //                     'user_password' => md5($_POST['user_passwordNew']),
    //                 );
    //                 $this->login_model->update_account($data);
    //             } else {
    ...
    //         }
    //     }
    //     header('location: ?act=user_email&xuli=account#doitk');
    // }
}
