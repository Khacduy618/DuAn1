...
class HomeController
{
    ...
    function list()
    {
        ...
        $trendingSell[] =$this->home_model->listproduct_trendingSell(6,0,4);
        $trendingSell[] =$this->home_model->listproduct_trendingSell(6,0,5);
        $trendingSell[] =$this->home_model->listproduct_trendingSell(6,0,6);
        $trendingSell[] =$this->home_model->listproduct_trendingSell(6,0,7);
        $trendingSell[] =$this->home_model->listproduct_trendingSell(6,0,11);
