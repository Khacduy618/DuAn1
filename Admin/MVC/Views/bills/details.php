        ...
        <div class="card-body">
            <?php if (!empty($billDetails) && is_array($billDetails)): ?>
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <p><strong>Product Price:</strong> <?php echo htmlspecialchars($billDetails['bill_product_price']); ?></p>
                        <p><strong>Delivery Price:</strong> <?php echo htmlspecialchars($billDetails['delivery_price']); ?></p>
