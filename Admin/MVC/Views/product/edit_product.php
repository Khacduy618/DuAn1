...
<div class="col-md-12">
    ...
    foreach($productbyid as $key => $pro){
        extract($pro);
    ?>
    <form action="?mod=product&act=update_product&param=<?=$product_id ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="number" value="<?=$product_price ?>" name="product_price" class="form-control"
                        required>
                </div>
                <div class="form-group">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" value="<?=$product_discount?>" name="product_discount" class="form-control"
                        required>
                </div>
                <div class="form-group">
                    <label for="product_count">Số Lượng:</label>
                    <input type="number" value="<?=$product_count ?>" name="product_count" class="form-control"
                        required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="product_cat" class="form-control">
                        ...
                        foreach($category as $key => $cate){ 
                            extract($cate);
                        ?>
                        <option <?php if($category_id==$product_cat) {echo'selected';}  ?>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-6">
                            <label for="product_count">Ngày Giờ Tự Động: </label>
                            <p>True</p>
                        </div>
                        <div class="col-md-6">
                            <label for="product_count">Ngày Giờ Tạo: </label>
                            <p><?=$created_at ?></p>
                        </div>
                    </div>
                </div>
