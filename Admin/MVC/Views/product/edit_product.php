...
<div class="col-md-12">
    ...
    foreach($productbyid as $key => $pro){
        extract($pro);
    ?>
    <form action="?mod=product&act=update_product&param=<?=$product_id ?>" method="POST" enctype="multipart/form-data"> <!-- enctype="multipart/form-data" vi khi phuong thuc gui file phai co cau lenh nay --> 
        <div class="row">
            <div class="col-md-6">
