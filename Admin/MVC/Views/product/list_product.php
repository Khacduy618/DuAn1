            ...
            <tbody>
                ...
                <tr v-for="item in paginateditems" :key="item.id">
                    ...
                    <td>
                        ...
                        <img src="<?= BASE_URL ?>/uploaded/<?=$product_img ?>" height="100" width="100" :alt="item.name"
                            class="item-img" @error="handleImageError">
                    </td>
                    <td><?=$product_name?></td>
                    <!-- <td>{{ item.name }}</td> -->

                    <!-- <td>${{ formatPrice(item.price) }}</td> -->
                    <td><?php echo number_format($product_price * (100 - $product_discount) / 100,0,',','.').'đ'?>(<?=$product_discount?>%)
                    </td>
                    <td>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <a class="btn btn-danger"
                                        href="?mod=product&act=delete_product&param=<?=$product_id ?>">delete</a>
                                </div>
                                <div class="col-6">
                                    <a class="btn btn-dark"
                                        href="?mod=product&act=edit_product&param=<?=$product_id ?>">edit</a>
                    </td>
    </div>
</div>
