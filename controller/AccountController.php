...
require_once 'model/user.php'; // Đảm bảo đường dẫn tới user.php là chính xác
...
class AccountController
{
    ...
    public function userPage()
    {
        ...
        include 'views/account/userPage.php'; // Tạo file này để hiển thị trang người dùng
    }
    ...
    public function edit()
    {
        ...
        include 'views/account/edit.php'; // Tải giao diện chỉnh sửa
    }
}
